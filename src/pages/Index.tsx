...
import { TranscriptDashboard } from "@/components/transcription/TranscriptDashboard";
...
const Index = () => {
  ...
  return <div className="tx-app"><SEO title="Transcript.art | AI Audio Transcription Workspace" description="Capture, transcribe, translate, review, and export audio with AI-assisted tools in a private workspace." url="/" siteName="Transcript.art" /><div className="tx-atmosphere" aria-hidden /><AppHeader isAuth={isAuth} userEmail={userEmail} loginUrl={loginUrl} signupUrl={signupUrl} onLogout={() => void logout()} />
